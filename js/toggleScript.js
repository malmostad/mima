...
$("#event-text-2.status_event_large").css('display','none'); /*d�ljer texten till "inkommen" statusen*/
$("#event-text-3.status_event_large").css('display','none'); /*d�ljer texten till "inkommen" statusen*/
$("#event-text-4.status_event_large").css('display','none'); /*d�ljer texten till "inkommen" statusen*/
...
$(document).ready(function(){
	$('.pagaende_arende_small').click(function(){ /*vid klick p� -.small_status div:en*/
